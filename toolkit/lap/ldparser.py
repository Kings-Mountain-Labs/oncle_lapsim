...
class ldEvent(object):
    ...
    def fromfile(self, f):
        ...
        return self(name, session, comment, venue_ptr, venue)
...
class ldVenue(object):
    ...
    def fromfile(self, f):
        ...
        return self(decode_string(name), vehicle_ptr, vehicle)
...
class ldVehicle(object):
    ...
    def fromfile(self, f):
        ...
        return self(id, weight, type, comment)
...
class ldHead(object):
    ...
    def fromfile(self, f):
        ...
        return self(meta_ptr, data_ptr, aux_ptr, aux, driver, vehicleid, venue, _datetime, short_comment, event, session)
...
class ldChan(object):
    ...
    def fromfile(self, _f, meta_ptr):
        ...
        name, short_name, unit = name.replace(" ", "_"), short_name.replace(" ", "_"), unit.replace(" ", "_")
        ...
        return self(_f, meta_ptr, prev_meta_ptr, next_meta_ptr, data_ptr, data_len,
...
def decode_string(bytes):
    ...
    """
    try:
        return bytes.decode('utf-8', 'ignore').strip().rstrip('\0').strip()
